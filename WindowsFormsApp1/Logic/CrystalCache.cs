...
namespace CrystalTable.Logic
{
    ...
    /// <summary>
    /// Сервис для работы с файлом кэша кристаллов и параметров пластины.
    /// </summary>
    internal static class CrystalCache
    {
        ...
        /// <summary>
        /// Пытается загрузить кристаллы и параметры пластины из кеша.
        /// </summary>
        public static bool TryLoad(string path, out WaferInfo info, out List<Crystal> crystals)
        {
            crystals = null;
            info = null;
            if (!File.Exists(path))
