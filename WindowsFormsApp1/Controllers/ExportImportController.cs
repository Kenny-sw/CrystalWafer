    ...
    public class ExportImportController
    {
        ...
        public void SaveWaferInfo(string sizeX, string sizeY, string diameter)
        {
            try
            {
                ...
                MessageBox.Show("Параметры сохранены!", "Уведомление",
        ...
        public void ExportData()
        {
            ...
            {
                Filter = "Компактный XML (*.xml)|*.xml|Детальный XML (*.xml)|*.xml|" +
        ...
        public (WaferInfo info, List<Crystal> crystals)? ImportData()
        {
            ...
            try
            {
                ...
                ApplyWaferInfo(result.info, false); // Не перестраивать кристаллы
                return result;
            }
            catch (Exception ex)
            {
        ...
        public (WaferInfo info, List<Crystal> crystals)? OpenFile()
        {
            ...
            try
            {
                ...
                MessageBox.Show("Файл успешно загружен!", "Уведомление",
                    MessageBoxButtons.OK, MessageBoxIcon.Information);
